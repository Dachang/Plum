...
/**
  View controller for creating scrolling app intros. Set animation times based on the page number, and this view controller handles calling \code
  animate:
  \endcode on the \code
  animator
  \endcode.
...
- (void)keepView:(UIView * _Nonnull)view onPage:(CGFloat)page;
- (void)keepView:(UIView * _Nonnull)view onPages:(NSArray<NSNumber *> * _Nonnull)pages;
- (void)keepView:(UIView * _Nonnull)view onPages:(NSArray<NSNumber *> * _Nonnull)pages atTimes:(NSArray<NSNumber *> * _Nonnull)times;
...
/**
  ...
  returns:
  The UIColor at the given progress point between the given starting and ending UIColors
*/
+ (UIColor * _Nonnull)interpolateFrom:(UIColor * _Nonnull)fromValue to:(UIColor * _Nonnull)toValue withProgress:(CGFloat)progress;
@end
