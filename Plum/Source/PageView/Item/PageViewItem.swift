...
class PageViewItem: UIView {
  ...
  init(radius: CGFloat, selectedRadius: CGFloat, borderColor: UIColor = UIColor(red: 1.00, green: 0.188, blue: 0.26, alpha: 1.00), lineWidth: CGFloat = 3, isSelect: Bool = false) {
...
extension PageViewItem {
  ...
  func animationSelected(_ selected: Bool, duration: Double, fillColor: Bool) {
    ...
    let toColor        = fillColor == true ? UIColor(red: 1.00, green: 0.188, blue: 0.26, alpha: 1.00) : UIColor.clear
...
extension PageViewItem {
  ...
  fileprivate func createCircleLayer(_ radius: CGFloat, lineWidth: CGFloat) -> CAShapeLayer {
    ...
    let layer = Init(CAShapeLayer()) {
      ...
      $0.strokeColor = UIColor(red: 1.00, green: 0.188, blue: 0.26, alpha: 1.00).cgColor
