...
class PageScrollView: DRPageScrollView {
	...
	override init(frame: CGRect) {
		let views = UIView.viewsByClassInNibNamed(name: "PageViews")
		self.firstPageView = views["Plum.FirstPageView"] as! FirstPageView
		self.secondPageView = views["Plum.SecondPageView"] as! SecondPageView
		self.thirdPageView = views["Plum.ThirdPageView"] as! ThirdPageView
		self.fourthPageView = views["Plum.FourthPageView"] as! FourthPageView
